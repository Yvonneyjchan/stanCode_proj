...
def main():
	"""
	Draw the Sierpinski triangle on GWindow among the specific order.
	"""
...
def sierpinski_triangle(order, length, upper_left_x, upper_left_y):
	...
	if order == 0:
		...
		line_h = GLine(upper_left_x, upper_left_y, upper_left_x+length, upper_left_y)
		line_l = GLine(upper_left_x, upper_left_y, upper_left_x+length*0.5, upper_left_y+length*0.866)
		line_r = GLine(upper_left_x+length, upper_left_y, upper_left_x+length*0.5, upper_left_y+length*0.866)
		window.add(line_h)
		window.add(line_l)
		window.add(line_r)
